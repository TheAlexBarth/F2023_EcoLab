...
Generally, the grading follows the generalized rubric we've used over the course of the class. However, some specifics which might be useful. Think of these as "minimum" requirements. A good paper should exceed these. For example, should should have tried to address your hypotheses which multiple analyses. You may not find it necessary to share every bit of exploratory data but you should include anything that is useful to advance the story you are trying to tell with your data.
